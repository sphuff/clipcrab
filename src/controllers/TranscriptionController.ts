...
import RevAIResponse, { RevAIElement } from '../types/RevAIResponse';
...
export {
    STATUS_TRANSCRIBED as STATUS_TRANSCRIBED,
    STATUS_NOT_TRANSCRIBED as STATUS_NOT_TRANSCRIBED,
};
...
export default class TranscriptionController {
     ...
     */
    static _getWordBlocks(transcriptObject: RevAIResponse) {
        /**
         * {
         *  "monologues": [{
         *      "elements": [{
        ...
        const wordBlocks = this.getWordBlocksWithPunctuation(words);
    ...
    static getWordBlocksWithPunctuation(elements: RevAIElement[]): WordBlock[] {
        let wordBlocks = [];
